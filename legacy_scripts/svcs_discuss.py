...
sys.path.insert(0, '.')
try:
    # Import all the specific API functions from centralized API
    from svcs.api import (
        find_dependency_changes, 
        get_commit_details, 
        get_full_log,
        get_node_evolution,
        # Enhanced functions for conversational interface
    ...
    print("Error: Could not import from 'svcs.api'. Please ensure SVCS is properly initialized.")
    sys.exit(1)
...
def get_system_instruction():
    """Returns the enhanced system prompt for the conversational REPL."""
    return """
